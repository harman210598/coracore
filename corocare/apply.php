...
<body>
    ...
    <a href="tel:123456789"
        ...
        <div id="applysection">
        <h1 style="color:red;">Lab</h1>
       
        <a href="lab_apply.php"> <img class="apply" id="lab" src="images/lab.jpg" alt="lab" /></a>
       
            
        <h1 style="color:red;">Hospital</h1>
       
        <a href="hospital_apply.php"><img  class="apply" id="hospital" src="images/hospital.jpg" alt="hospital" /></i></a>

    ...
    <div class="main-block">
      ...
      <form action="" method="POST">
        ...
        <div class="info">
          ...
          <select id="selectType" style="width: 100%; height: 30px; " name="types">
      ...
      <?php
        if(isset($_POST['submit']))
        {
         ...
         $sql_data="INSERT into test_data (name,email,phone,types,message)
         values('$name','$email','$phone','$types','$message')";
